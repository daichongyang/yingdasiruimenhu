  ...
  <section>
    <div class="index_box">
      ...
      <div class="content_box4">
        <div class="banner_img content_box4_img" :style="{backgroundImage:'url('+showImg+')'}"></div>
        <div class="content_box4_text">
          ...
          <div class="content_box4_text4">Read More</div>
        </div>
      </div>
      <div class="content_box4">
        <div class="banner_img content_box4_img" :style="{backgroundImage:'url('+content_box_2_item_img+')'}"></div>
        <div class="content_box4_text">
          <div class="card-body">
            <h6>Adrian Lie</h6>
          </div>
...
export default {
  ...
  methods:{
    getImgList(){
      getMessage(this.seach).then((res)=>{
        console.log(res)
